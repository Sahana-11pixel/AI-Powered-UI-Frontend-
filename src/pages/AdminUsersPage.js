                        ...
                        <table className="w-full text-left">
                                ...
                                <tr>
                                    ...
                                    >
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div className="flex flex-col -gap-1">
                                                <ChevronLeft className={`w-3 h-3 rotate-90 transition-colors ${sortBy === 'name' && sortOrder === 'asc' ? 'text-purple-400' : 'theme-icon-dim'}`} />
                                                <ChevronLeft className={`w-3 h-3 -rotate-90 transition-colors ${sortBy === 'name' && sortOrder === 'desc' ? 'text-purple-400' : 'theme-icon-dim'}`} />
                                            </div>
                                        </div>
                                    </th>
                                    <th
                                    ...
                                    >
                                        <div className="flex items-center gap-2">
                                            Email
                                            <div className="flex flex-col -gap-1">
                                                <ChevronLeft className={`w-3 h-3 rotate-90 transition-colors ${sortBy === 'email' && sortOrder === 'asc' ? 'text-purple-400' : 'theme-icon-dim'}`} />
                                                <ChevronLeft className={`w-3 h-3 -rotate-90 transition-colors ${sortBy === 'email' && sortOrder === 'desc' ? 'text-purple-400' : 'theme-icon-dim'}`} />
                                            </div>
                                        </div>
                                    </th>
                                    ...
                                    >
                                        <div className="flex items-center gap-2">
                                            Joined
                                            <div className="flex flex-col -gap-1">
                                                <ChevronLeft className={`w-3 h-3 rotate-90 transition-colors ${sortBy === 'created_at' && sortOrder === 'asc' ? 'text-purple-400' : 'theme-icon-dim'}`} />
                                                <ChevronLeft className={`w-3 h-3 -rotate-90 transition-colors ${sortBy === 'created_at' && sortOrder === 'desc' ? 'text-purple-400' : 'theme-icon-dim'}`} />
                                            </div>
                                        </div>
                                    </th>
                            ...
                            <tbody className="divide-y divide-purple-500/10 theme-text-secondary">
                                {loading ? (
                                    <tr>
                                        <td colSpan="6" className="px-6 py-12 text-center">
                                            <div className="flex items-center justify-center gap-3">
                                                ...
                                                <span className="theme-text-tertiary font-medium">Loading users...</span>
                                            </div>
                                        </td>
                                    </tr>
                                ) : fetchError ? (
                                        ...
                                        <tr key={u.id} className="hover:bg-white/[0.02] transition-colors">
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-2 flex-wrap">
                                                    ...
                                                    {u.is_deleted && (
                                                        <span className="px-2 py-1 text-[10px] uppercase tracking-wider font-bold rounded-md theme-bg-hover/50 theme-text-tertiary border theme-border">
                                                            Deactivated
                                                        </span>
                                                    )}
                                                    {!u.is_deleted && (
                                    ...
                                    <tr>
                                        <td colSpan="6" className="px-6 py-12 text-center theme-text-tertiary italic">
                        ...
                        <div className="px-6 py-4 theme-bg-secondary border-t theme-border flex items-center justify-between gap-4">
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    disabled={page === 1}
                                    className="p-2 theme-bg-card-solid border border-purple-500/20 rounded-lg theme-text-secondary hover:theme-text disabled:opacity-30 disabled:cursor-not-allowed transition-all"
                                >
                                ...
                                {[...Array(totalPages)].map((_, i) => (
                                    <button
                                        ...
                                        className={`w-8 h-8 rounded-lg text-xs font-semibold transition-all ${page === i + 1
                                            ? 'bg-purple-600 theme-text border border-purple-400/50 shadow-[0_0_12px_rgba(147,51,234,0.3)]'
                                            : 'theme-bg-card-solid border border-purple-500/10 theme-text-tertiary hover:theme-text hover:border-purple-500/40'
                                            }`}
                                    >
                                        {i + 1}
                                    </button>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
                    ...
                    >
                        ...
                        <div className="p-8">
                            {detailsLoading ? (
                                <div className="py-12 flex flex-col items-center justify-center gap-4">
                                    ...
                                    <p className="theme-text-tertiary font-medium">Fetching member details...</p>
                                </div>
                            ) : selectedUser ? (
                                <div className="space-y-8">
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                                        ...
                                        <div className="bg-amber-500/5 border border-amber-500/10 rounded-2xl p-4 flex flex-col items-center gap-2">
                                            ...
                                            <span className="text-[10px] font-bold theme-text text-center leading-tight">
                                    ...
                                    <div className="space-y-4">
                                        {selectedUser.total_projects === 0 && (
                                            <div className="px-4 py-3 bg-white/[0.02] border border-dashed theme-border rounded-2xl">
                                                <p className="text-xs theme-text-tertiary italic text-center">No projects created yet.</p>
                                            </div>
                                        )}

                                        <div className={`flex items-center justify-between p-4 border rounded-2xl ${selectedUser.is_deleted ? 'theme-bg-card-solid/40 theme-border' : 'bg-white/[0.02] theme-border'}`}>
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    {selectedUser.is_deleted ? (
                                                        <p className="text-xs theme-text-tertiary">Account has been deactivated</p>
                                                    ) : (
                                                        <p className="text-xs theme-text-tertiary">Verified and active member</p>
                                                    )}
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-2">
                        ...
                        <div className="px-8 py-6 theme-bg-secondary border-t theme-border flex items-center justify-between gap-4">
                            ...
                            <button
                                onClick={() => setIsModalOpen(false)}
                                className="px-6 py-2.5 theme-bg-card-solid hover:theme-bg-hover theme-text font-semibold rounded-xl border theme-border transition-all"
                            >
                                Close
                            </button>
                        </div>
                        ...
                        <div className="p-8">
                            ...
                            <div className="flex gap-4">
                                <button
                                    ...
                                    disabled={isDeleting}
                                    className="flex-1 px-6 py-3 theme-bg-hover hover:theme-bg-hover theme-text font-semibold rounded-2xl transition-all border theme-border disabled:opacity-50"
                                >
                                    Cancel
                                </button>
                                <button
                                    ...
                                    disabled={isDeleting}
                                    className="flex-1 px-6 py-3 bg-rose-600 hover:bg-rose-500 theme-text font-bold rounded-2xl shadow-lg  transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                                >
                                    {isDeleting ? (
                                        <>
                                            <div className="w-4 h-4 border-2 theme-border border-t-white rounded-full animate-spin"></div>
                                            Deleting...
                                        </>
                                    ) : (
                                        'Confirm Delete'
                ...
                <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
                    ...
                    >
                        <div className="p-8">
                            ...
                            <p className="theme-text-placeholder text-center text-xs mb-8">
                            ...
                            <div className="flex gap-4">
                                ...
                                <button
                                    ...
                                    disabled={isReactivating}
                                    className="flex-1 px-6 py-3 bg-emerald-600 hover:bg-emerald-500 theme-text font-bold rounded-2xl shadow-lg  transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                                >
                                    {isReactivating ? (
                                        <>
                                            <div className="w-4 h-4 border-2 theme-border border-t-white rounded-full animate-spin"></div>
