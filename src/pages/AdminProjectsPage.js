                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                        ...
                        <div className="relative group">
                            <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 theme-text-tertiary group-focus-within:text-purple-400 transition-colors" />
                            <input
                                type="text"
                        ...
                        {/* Framework Filter */}
                        <div className="relative group">
                            <Filter className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 theme-text-tertiary group-focus-within:text-purple-400 transition-colors" />
                            <select
                            ...
                            >
                                {frameworks.map(f => (
                                    <option key={f.id} value={f.id} className="theme-bg-primary">{f.name}</option>
                                ))}
                            </select>
                        </div>
                    </div>
                        ...
                        <table className="w-full">
                                ...
                                <tr>
                                    ...
                                    >
                                        <div className="flex items-center gap-2">
                                            Owner Email
                                            <div className="flex flex-col -gap-1">
                                                <ChevronLeft className={`w-3 h-3 rotate-90 transition-colors ${sortBy === 'ownerEmail' && sortOrder === 'asc' ? 'text-purple-400' : 'theme-icon-dim'}`} />
                                                <ChevronLeft className={`w-3 h-3 -rotate-90 transition-colors ${sortBy === 'ownerEmail' && sortOrder === 'desc' ? 'text-purple-400' : 'theme-icon-dim'}`} />
                                            </div>
                                        </div>
                                    </th>
                                    ...
                                    >
                                        <div className="flex items-center gap-2">
                                            Created Date
                                            <div className="flex flex-col -gap-1">
                                                <ChevronLeft className={`w-3 h-3 rotate-90 transition-colors ${sortBy === 'createdAt' && sortOrder === 'asc' ? 'text-purple-400' : 'theme-icon-dim'}`} />
                                                <ChevronLeft className={`w-3 h-3 -rotate-90 transition-colors ${sortBy === 'createdAt' && sortOrder === 'desc' ? 'text-purple-400' : 'theme-icon-dim'}`} />
                                            </div>
                                        </div>
                                    </th>
                            ...
                            <tbody className="divide-y divide-purple-500/10">
                                {loading && projects.length === 0 ? (
                                    <tr>
                                        <td colSpan="5" className="px-6 py-12 text-center">
                                            <div className="flex flex-col items-center gap-3">
                                                ...
                                                <p className="theme-text-tertiary font-medium">Loading projects...</p>
                                            </div>
                                        </td>
                                    </tr>
                                ) : fetchError ? (
                                        ...
                                        <tr key={p.id} className="hover:bg-white/[0.02] transition-colors group">
                                            ...
                                            <td className="px-6 py-4">
                                                <span className={`px-2 py-1 text-[10px] font-bold uppercase tracking-wider rounded-lg ${p.framework === 'react' ? 'bg-cyan-500/10 text-cyan-400 border border-cyan-500/20' :
                                                    p.framework === 'nextjs' ? 'theme-bg-hover theme-text border theme-border' :
                                    ...
                                    <tr>
                                        <td colSpan="5" className="px-6 py-12 text-center theme-text-tertiary">
                        ...
                        <div className="px-6 py-4 theme-bg-secondary border-t theme-border flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    disabled={page === 1}
                                    className="p-2 theme-bg-card-solid border theme-border rounded-lg theme-text disabled:opacity-30 hover:theme-bg-hover transition-colors"
                                >
                                    ...
                                    {[...Array(totalPages)].map((_, i) => (
                                        <button
                                            ...
                                            className={`w-8 h-8 rounded-lg text-xs font-bold transition-all ${page === i + 1
                                                ? 'bg-purple-600 theme-text'
                                                : 'theme-text-tertiary hover:theme-bg-hover'
                                                }`}
                                        >
                                            {i + 1}
                                        </button>
                    ...
                    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
                        ...
                        >
                            <div className="p-8">
                                ...
                                {selectedProject ? (
                                    ...
                                    <div className="py-20 flex flex-col items-center gap-4">
                                        ...
                                        <p className="theme-text-tertiary italic">Retrieving metadata...</p>
                                    </div>
                                )}
                            </div>
                            <div className="px-8 py-6 theme-bg-secondary border-t theme-border flex justify-end">
                                <button
                                    onClick={() => setIsModalOpen(false)}
                                    className="px-8 py-3 theme-bg-card-solid hover:theme-bg-hover theme-text font-bold rounded-2xl border theme-border transition-all"
                                >
                                    Done
                                </button>
                            </div>
