...
import CodeGeneratingOverlay from '../components/CodeGeneratingOverlay';
...
const UploadPage = () => {
  ...
  return (
    <Layout>
      <CodeGeneratingOverlay isVisible={loading} />
          ...
          >
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <p className="text-xs theme-text-secondary mb-4">Applicable only for basic layouts</p>
