...
const LoginPage = () => {
    ...
    try {
      ...
      if (!refreshedUser.emailVerified) {
        const actionCodeSettings = {
          url: `${window.location.origin}/auth-action?flow=verify`,
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      const actionCodeSettings = {
        url: `${window.location.origin}/auth-action?flow=reset`,
        handleCodeInApp: true,
      };
          ...
          <div className="theme-bg-card border theme-border rounded-2xl p-8 backdrop-blur-xl theme-shadow theme-transition">
            ...
            <div className="mt-4 pt-4 border-t theme-border text-center">
              <p className="text-xs theme-text-tertiary">
                Having trouble?{' '}
                <a href="mailto:uicodegensupport@gmail.com" className="text-purple-400 hover:underline">
                  Contact Support
                </a>
              </p>
            </div>
